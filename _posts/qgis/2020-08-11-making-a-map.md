...
5. Use the pan and zoom controls in the Map Navigation Toolbar and zoom to New Zealand.![image of browse data](../../images/2_zoom_pan_nz.png). You can see that the map kind of ends half way in the map view. This is because of the date line. The map extent specified to end there, however, it is possible to re-define the map center line and therefore also the western-most and eastern-most borders. 
