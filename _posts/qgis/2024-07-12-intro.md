...
The materials are partially based on Ujaval Gandhi's [QGIS Tutorials and Tips](https://www.qgistutorials.com/en/docs/introduction.html) and [QGIS Desktop User Guide](https://docs.qgis.org/3.34/en/docs/user_manual/index.html), under CC-BY-SA. If you wish to modify the materials, we wish that you would also share your materials openly e.g. on GitHub where everyone could benefit from you work, in a similar manner as we provide these materials for you.
...
The materials are mainly authored by Prof. Evelyn Uuemaa and have contributions from Marie Annusver.
...
### 1. Installation
**These tutorials are made with QGIS version 3.28 for Windows** and therefore it is the easiest to follow them in version 3.28 and on a PC. However, you can also easily follow them when using one the latest stable version QGIS 3.34 (3.44 is not recommended because it has some bugs) and the newest release 4.2. QGIS can be downloaded from [here](https://qgis.org/en/site/forusers/download.html). Version 3.28 and 3.24 can be downloaded from [here](https://download.qgis.org/downloads/)
