...
### 1. Installation
**These tutorials are made with QGIS version 3.16 for Windows** and therefore it is the easiest to follow them in version 3.28 and on a PC. QGIS can be downloaded from [here](https://qgis.org/en/site/forusers/download.html). Version 2.32 is not recommended yet because it is not stable.
